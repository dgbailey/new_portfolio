            ...
            <StyledGlobalTopContainer onClick={this.hideContactPopup}>
                ...
                <div className="parallax__layer parallax__layer--b">
                    ...
                    <div className="content-container full">
                        ...
                        <div className="under-carousel-description-cont">
                            <p className="ucd-paragraph">Flocks analyzes the toxcicity of tweets. The frontend leveraged the Twitter API to facilitate searches of <a href="https://github.com/flocks1/login/blob/master/src/components/ItemList.js">trending topics</a> and to display tweets processed by the toxcicity algorithm.  Pace was a major challenge during this project as there were only three real coding days.  Consequently, sourcing and <a href ="https://github.com/flocks1/login/blob/master/src/components/DataVisVue.js">integrating</a> with third party data visualization components was an essential compromise. The team included four data science students + Google's open source natural language processing (BERT) and
                            one backend engineer.  The Sentiment API is still in progress. I was responsible for the entire frontend component architecture and design.</p>
                            <div className="ucd-infographic">
                                <div className="icon-container">
                                    <div className="icon-position-container">
                                        <div className="ucd-icon"><h1 className="icon-number">6</h1></div>
                ...
                <div className="parallax__layer parallax__layer--d">
                    ...
                    <div className="content-container full">
                        ...
                        <div className="under-carousel-description-cont">
                            <p className="ucd-paragraph">The Void is a <a href="https://en.wikipedia.org/wiki/MUD">multi-user dungeon</a> (aka a multi-player game). This project required me to learn a completely new web framework &mdash; Django &mdash; in order to extend & deploy an inherited codebase.<br></br><br></br> I collaborated with another backend engineer to create a flexible development pipeline facilitating local development on Django's native SQLite while deploying to PostgreSQL on Heroku.  I also enjoyed implementing a <a href="https://github.com/cs-build-week1-good-dev/mud-frontend/blob/master/src/components/main/ChatWindow.js">WebSocket based chat feature</a> on the frontend and backend.  The <a href="https://pusher.com/docs/channels">Pusher API</a> provided the backbone for our room specific chat channels.</p> 
                            <div className="ucd-infographic">
                                <div className="icon-container">
                                    <div className="icon-position-container">
