            ...
            <StyledGlobalTopContainer className="global-slide-container" onClick={this.hideContactPopup}>
                ...
                <div className="parallax__layer parallax__layer--b">
                    ...
                    <div className="content-container full">
                        ...
                        <div className="under-carousel-description-cont">
                            <p className="ucd-paragraph">Flocks analyzes the toxicity of tweets. The front end leveraged the Twitter API to facilitate searches of <a href="https://github.com/flocks1/login/blob/master/src/components/ItemList.js">trending topics</a> and to display tweets processed by the toxcicity algorithm.  Pace was a major challenge during this project as there were only three real coding days.  Consequently, sourcing and <a href ="https://github.com/flocks1/login/blob/master/src/components/DataVisVue.js">integrating</a> with third party data visualization components was an essential compromise. The team included four data science students + Google's open source natural language processing (BERT) and
